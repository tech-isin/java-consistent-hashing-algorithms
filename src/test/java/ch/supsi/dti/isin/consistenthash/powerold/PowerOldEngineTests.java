package ch.supsi.dti.isin.consistenthash.powerold;
...
/**
 * Test suite for the class {@link PowerOldEngine}.
 * 
 * @author Massimo Coluzzi
 */
@DisplayNameGeneration(DisplayNameGenerator.ReplaceUnderscores.class)
public class PowerOldEngineTests implements Contract<PowerOldEngine>
{
    ...
    /**
     * Creates a new {@link PowerOldEngine} with the given size.
     * 
     * @param size size of the cluster
     * @return new instance of {@link PowerOldEngine}
     */
    public PowerOldEngine sampleValue( int size )
    {

        return new PowerOldEngine( size, ConsistentHash.DEFAULT_HASH_FUNCTION );
     ...
     */
    @Override
    public PowerOldEngine sampleValue()
    {
    ...
    public void a_new_created_engine_should_have_the_expected_size()
    {
        ...
        final PowerOldEngine engine = sampleValue( size );
    ...
    public void removing_a_bucket_when_size_gt_m2_plus_1_should_decrease_the_size_but_not_m()
    {
        ...
        final PowerOldEngine engine = sampleValue( size + 1 );
    ...
    public void if_the_cluster_has_one_node_all_the_keys_should_land_to_such_a_node()
    {
        ...
        final PowerOldEngine engine = new PowerOldEngine( 1, ConsistentHash.DEFAULT_HASH_FUNCTION );
        for( int i = 0; i < 100; ++i )
        {
    ...
    public void if_the_cluster_has_multiple_nodes_each_node_should_get_some_key()
    {
        ...
        final PowerOldEngine engine = new PowerOldEngine( 10, ConsistentHash.DEFAULT_HASH_FUNCTION );       
