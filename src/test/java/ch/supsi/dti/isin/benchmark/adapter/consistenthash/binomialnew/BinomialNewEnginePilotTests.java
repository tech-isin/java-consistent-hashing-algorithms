...
/**
 * Suite to test the {@link BinomialNewEnginePilot} class.
 * 
 * @author Massimo Coluzzi
 */
@DisplayNameGeneration(DisplayNameGenerator.ReplaceUnderscores.class)
public class BinomialNewEnginePilotTests
{
    ...
    public void the_engine_to_test_is_mandatory()
    {
        ...
        assertThrows( RequirementFailure.class, () -> new BinomialNewEnginePilot(null) );
    ...
    public void the_added_node_should_have_the_expected_name()
    {
        ...
        final BinomialNewEngine engine = new BinomialNewEngine( nodes, HashFunction.create(HashFunction.Algorithm.XX) );
        final BinomialNewEnginePilot pilot = new BinomialNewEnginePilot( engine );
    ...
    public void the_added_node_should_be_retrieved_using_get()
    {
        ...
        final BinomialNewEngine engine = new BinomialNewEngine( 1, HashFunction.create(HashFunction.Algorithm.XX) );
        final BinomialNewEnginePilot pilot = new BinomialNewEnginePilot( engine );
