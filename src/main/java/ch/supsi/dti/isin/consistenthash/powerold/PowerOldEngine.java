...
/**
 * Implementation of the {@code PowerOldHash} algorithm as described in the related paper:
 ...
 */
public class PowerOldEngine implements BucketBasedEngine
{
     ...
     */
    public PowerOldEngine( int size, HashFunction hashFunction )
    {
