...
/**
 * Wrapper to adapt the {@link BinomialNewEngine} to the {@link ConsistentHash} interface.
 * 
 ...
 */
public class BinomialNewHash implements ConsistentHash
{


    /**
     * The {@code BinomialNewHash} algorithm engine as described in:
     * {@code N/A}
     */
    private final BinomialNewEngine engine;
     ...
     */
    public BinomialNewHash( Collection<? extends Node> nodes )
    {
     ...
     */
    public BinomialNewHash( Collection<? extends Node> initNodes, HashFunction hashFunction )
    {
        ...
        this.engine = new BinomialNewEngine(
            size,
