...
/**
 * Wrapper to adapt the {@link PowerOldEngine} to the {@link ConsistentHash} interface.
 * 
 ...
 */
public class PowerOldHash implements ConsistentHash
{


    /**
     * The {@code PowerOldHash} algorithm engine as described in:
     * {@code https://arxiv.org/pdf/2307.12448.pdf}
     */
    private final PowerOldEngine engine;
     ...
     */
    public PowerOldHash( Collection<? extends Node> nodes )
    {
     ...
     */
    public PowerOldHash( Collection<? extends Node> initNodes, HashFunction hashFunction )
    {
        ...
        this.engine = new PowerOldEngine(
            size,
